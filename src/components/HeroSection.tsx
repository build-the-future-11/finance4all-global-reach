    ...
    <section className="relative h-screen flex flex-col items-center justify-center text-center overflow-hidden px-4">
      ...
      <div className="relative z-10 max-w-4xl">
        <div className="relative rounded-[36px] p-12 border border-white/20 backdrop-blur-2xl bg-white/[0.06] shadow-[0_40px_140px_rgba(0,0,0,0.7)] overflow-hidden">
          ...
          <p className="mb-4 text-xs sm:text-sm uppercase tracking-[0.22em] text-emerald-200/90">
            FinanceMeta · Research, education & technical builds
          </p>
          ...
          <h1 className="mb-6 text-5xl sm:text-6xl font-bold tracking-tight leading-tight">
            ...
            <br />
            <span className="text-white">Build what the evidence supports.</span>
          </h1>
          ...
          <div className="flex flex-wrap justify-center gap-12 mb-10 text-white">
            <div>
              ...
              <p className="text-xs uppercase tracking-widest text-white/60">Fall research labs</p>
            </div>
            <div>
              <p className="text-3xl font-bold text-emerald-300">Open</p>
              <p className="text-xs uppercase tracking-widest text-white/60">Program intake</p>
            </div>
            <div>
              <p className="text-3xl font-bold text-emerald-300">Evidence</p>
              <p className="text-xs uppercase tracking-widest text-white/60">Before outcomes</p>
            </div>
          </div>
