...
const links = [
  ...
  { label: "Research & Builds", href: "#projects" },
          ...
          >
            ...
            <div className="relative z-10 flex items-center justify-between">
              ...
              <div className="hidden items-center gap-2 md:flex">
                ...
                <a
                  href="#join"
                  className="ml-2 rounded-full bg-white/90 px-4 py-2 text-sm font-semibold text-black transition hover:bg-white"
                >
                  Join
                </a>
              </div>
          ...
          >
            <div className="mt-3 rounded-3xl border border-white/20 bg-white/[0.07] p-3 backdrop-blur-xl">
              ...
              <a
                href="#join"
                onClick={() => setOpen(false)}
                className="mt-2 block rounded-xl bg-white/90 px-4 py-3 text-center text-sm font-semibold text-black"
              >
                Join
              </a>
            </div>
